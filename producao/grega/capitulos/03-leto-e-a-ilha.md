...
Antes daquele dia, a ilha se chamava **Astéria**, "a estrelada", e vagava pelo mar sem parar em lugar nenhum — por isso quase ninguém a encontrava. Depois que criou raízes, os navegantes gregos passaram a chamá-la de **Delos**, que quer dizer "a que se vê". A ilha que ninguém achava virou a que todo mundo enxerga de longe.

*(Fonte: Calímaco, Hino IV a Delos — dossiê, "Material para Você sabia?", fato 2.)*

## Cena da ilustração

**A ilha ancorando** (cena confirmada no dossiê, §"Cena central sugerida", com a estratégia dual X13 e a decisão X14 do gate da Fase 1).

Momento: o instante **seguinte** ao nascimento — nada em curso, tudo recém-acontecido.
...
- **Delos** (*DÉ-los*) — ilha pequena e rochosa do mar Egeu, onde nasceram Ártemis e Apolo. Não confundir com **Delfos**, que é outro lugar.
- **Astéria** (*as-TÉ-ri-a*) — "a estrelada": o nome da ilha enquanto ela ainda vagava pelo mar.
...
- **A4** — "revirar e empurrar para as profundezas" reenquadrado como "e se ele for embora?", conservando o medo inteiro.
- **A5 (adaptação)** — paternidade em uma linha, sem moldura conjugal. **A6 (adaptação)** — "virgem" traduzida como "nunca quis se casar" (glossário) e "dona de todas as florestas" (texto).
- **Não-transação:** a ilha em nenhum momento é *recompensada*. Ela **para de vagar** e **passa a ser vista** — mudança de estatuto, não prêmio. Nenhuma frase do tipo "e assim a ilha foi recompensada".
